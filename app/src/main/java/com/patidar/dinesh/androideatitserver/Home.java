...
import com.patidar.dinesh.androideatitserver.Model.Category;
import com.patidar.dinesh.androideatitserver.Model.Token;
import com.patidar.dinesh.androideatitserver.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        categories = database.getReference("Restaurants").child(Common.currentUser.getRestaurantId()).child("detail").child("categories");
    ...
    private void loadMenu() {
        ...
        adapter.notifyDataSetChanged(); // referesh data if have data change
